...
public class MessageAdapter extends ArrayAdapter<Preguntas> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView respuesta1TextView = (TextView) convertView.findViewById(R.id.respuesta1TextView);
        TextView respuesta2TextView = (TextView) convertView.findViewById(R.id.respuesta2TextView);
        TextView respuesta3TextView = (TextView) convertView.findViewById(R.id.respuesta3TextView);
        TextView respuesta4TextView = (TextView) convertView.findViewById(R.id.respuesta4TextView);
